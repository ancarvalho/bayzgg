                ...
                <div className="flex items-center justify-between w-full lg:w-auto">
                  ...
                  >
                    <div >
                      ...
                      >
                        <g
                          transform="matrix(.61356 0 0 .61356 3.9614 26.381)"
                          fontStyle="shape-inside:url(#rect3359);white-space:pre"
                          aria-label="BAYZ">
                          <path
                            transform="matrix(.43123 0 0 .43123 -6.4565 -42.996)"
                            d="m116.01 15.625c-2.0014 0-3.8301 1.1306-4.6133 3.0449l-26.627 62.303h10.703l20.449-47.684 20.188 47.684h10.703l-26.365-62.303c-0.78314-1.9143-2.4361-3.0449-4.4375-3.0449zm-95.805 0.95703c-2.7845 0-5.1348 2.2624-5.1348 5.0469v54.211c0 2.7845 2.3503 5.1328 5.1348 5.1328h28.715c10.181 0 18.447-8.3532 18.447-18.621 0-6.5262-3.3923-11.572-8.6133-14.27 4.0027-2.9585 6.4375-7.3967 6.4375-13.053 0-10.181-8.2653-18.447-18.533-18.447h-26.453zm129.22 0 26.104 43.855v20.535h9.5723v-20.535l26.105-43.855h-11.312l-19.578 33.24-19.58-33.24h-11.311zm79.443 0v9.5723h39.332l-39.332 46.814c-0.69613 0.87016-1.1309 1.9137-1.1309 3.0449 0 2.7845 2.1764 4.959 4.9609 4.959h48.729v-9.5703h-38.723l39.332-46.814c0.69613-0.87016 1.043-1.9146 1.043-3.1328 0-2.6975-2.1756-4.873-4.873-4.873h-49.338zm-204.22 9.5723h22.016c4.9599 0 8.9629 4.0021 8.9629 8.875 0 4.9599-4.003 8.9629-8.9629 8.9629h-22.016v-17.838zm0 27.41h24.277c4.8729 0 8.875 3.9142 8.875 8.7871 0 4.9599-4.0021 9.0508-8.875 9.0508h-24.277v-17.838z"
                            strokeWidth="2.319" />
                        </g>
                      </svg>
                    </div>
